...
function handler(event) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, name, email, message, transporter, mailOptions, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = JSON.parse(event.body), name = _a.name, email = _a.email, message = _a.message;
                    ...
                    mailOptions = {
                        from: "\"Website Contact\" <".concat(email, ">"),
